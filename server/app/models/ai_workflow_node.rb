...
class AiWorkflowNode < ApplicationRecord
  # Extracted concerns
  include AiWorkflowNode::NodeTypes
  include AiWorkflowNode::Connections
  include AiWorkflowNode::ConfigurationHelpers
  include AiWorkflowNode::Validation
  include AiWorkflowNode::Statistics
  include AiWorkflowNode::Positioning
