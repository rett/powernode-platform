...
module Marketplace
  class Plan < ApplicationRecord
    ...
    has_many :subscriptions, class_name: "Marketplace::Subscription", foreign_key: "app_plan_id", dependent: :destroy
    ...
    def enabled_app_features
      app.features.where(slug: features)
    end

    def available_features
      app.features.where.not(slug: features)
    end
    ...
    def one_time_revenue
      ...
      subscriptions.count * price_dollars
    end
    ...
    def compare_to(other_plan)
      return nil unless other_plan.is_a?(Marketplace::Plan) && other_plan.app == app
    ...
    def upgrade_from?(other_plan)
      return false unless other_plan.is_a?(Marketplace::Plan) && other_plan.app == app
    ...
    def generate_slug
      ...
      while app.plans.exists?(slug: candidate_slug)
    ...
    def validate_features_exist
      ...
      existing_features = app.features.pluck(:slug)
