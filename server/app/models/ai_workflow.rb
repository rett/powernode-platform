...
class AiWorkflow < ApplicationRecord
  ...
  # Extracted concerns
  include AiWorkflow::StateChecks
  include AiWorkflow::StructureValidation
  include AiWorkflow::Execution
  include AiWorkflow::Templates
  include AiWorkflow::Duplication
  include AiWorkflow::Statistics
  include AiWorkflow::Versioning
