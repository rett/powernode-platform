...
module Integration
  class Instance < ApplicationRecord
    ...
    # ==================== Associations ====================
    belongs_to :account
    belongs_to :template, class_name: "Integration::Template", foreign_key: "integration_template_id"
    belongs_to :credential, class_name: "Integration::Credential", foreign_key: "integration_credential_id", optional: true
    belongs_to :created_by_user, class_name: "User", optional: true

    has_many :executions, class_name: "Integration::Execution", foreign_key: "integration_instance_id", dependent: :destroy
    ...
    scope :by_type, ->(type) { joins(:template).where(integration_templates: { integration_type: type }) }
    ...
    def generate_slug
      ...
      counter = 1
      while Integration::Instance.where(account_id: account_id, slug: slug).exists?
...
IntegrationInstance = Integration::Instance
