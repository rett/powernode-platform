...
module Integration
  class Execution < ApplicationRecord
    ...
    # ==================== Associations ====================
    belongs_to :instance, class_name: "Integration::Instance", foreign_key: "integration_instance_id"
    belongs_to :account
    belongs_to :triggered_by_user, class_name: "User", optional: true
    belongs_to :parent_execution, class_name: "Integration::Execution", optional: true

    has_many :retry_executions, class_name: "Integration::Execution", foreign_key: :parent_execution_id, dependent: :nullify
...
# Backward compatibility alias
IntegrationExecution = Integration::Execution
