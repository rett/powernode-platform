...
module Integration
  class Credential < ApplicationRecord
    ...
    has_many :instances, class_name: "Integration::Instance", foreign_key: "integration_credential_id", dependent: :nullify
    ...
    def decrypt_credentials
      ...
      if Rails.env.test?
        ...
        Integrations::Security::CredentialEncryptionService.decrypt(
    ...
    def encrypt_credentials(credentials_hash)
      ...
      if Rails.env.test?
        ...
        Integrations::Security::CredentialEncryptionService.encrypt(credentials_hash)
      end
    end

    def current_encryption_key_id
      Rails.env.test? ? "test_key" : Integrations::Security::CredentialEncryptionService.current_key_id
    end
