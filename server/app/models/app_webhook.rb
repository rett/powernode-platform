...
class AppWebhook < ApplicationRecord
  # Associations
  belongs_to :app
  has_many :app_webhook_deliveries, dependent: :destroy
  ...
  def generate_slug
    ...
    while app&.app_webhooks&.exists?(slug: potential_slug)
      counter += 1
