  ...
  class WorkflowNode
    module ConfigurationHelpers
      ...
      def ai_agent
        ...
        workflow.account.ai_agents.find_by(id: configuration["agent_id"])
      end
      ...
      def valid_configuration_for_type?
        ...
        when "kb_article"
          Ai::WorkflowNode::KB_ARTICLE_ACTIONS.include?(configuration["action"])
        when "page"
          Ai::WorkflowNode::PAGE_ACTIONS.include?(configuration["action"])
        when "mcp_operation"
          Ai::WorkflowNode::MCP_OPERATION_TYPES.include?(configuration["operation_type"]) &&
