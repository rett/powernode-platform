...
module Devops
  class GitPipeline < ApplicationRecord
    ...
    has_many :jobs, class_name: "Devops::GitPipelineJob", foreign_key: "git_pipeline_id", dependent: :destroy
    has_many :approvals, class_name: "Devops::GitPipelineApproval", foreign_key: "git_pipeline_id", dependent: :destroy
