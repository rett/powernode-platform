...
module CiCd
  ...
  class PipelineRun < ApplicationRecord
    ...
    has_many :step_executions, class_name: 'CiCd::StepExecution', foreign_key: :ci_cd_pipeline_run_id, dependent: :destroy
    ...
    def ordered_step_executions
      step_executions.joins(:pipeline_step).order('ci_cd_pipeline_steps.position ASC')
    end
    ...
    def enqueue_execution
      CiCd::PipelineExecutionJob.perform_async(id)
    end
    ...
    def broadcast_created
      CiCdPipelineChannel.broadcast_run_created(self)
    end

    def broadcast_updated
      if completed?
        CiCdPipelineChannel.broadcast_run_completed(self)
      else
        CiCdPipelineChannel.broadcast_run_updated(self)
      end
    end
  end
end
