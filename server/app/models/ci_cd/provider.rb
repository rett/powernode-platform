...
module CiCd
  ...
  class Provider < ApplicationRecord
    ...
    has_many :repositories, class_name: 'CiCd::Repository', foreign_key: :ci_cd_provider_id, dependent: :destroy
    has_many :pipelines, class_name: 'CiCd::Pipeline', foreign_key: :ci_cd_provider_id, dependent: :restrict_with_error
    ...
    def credential
      ...
      Rails.application.credentials.dig(:ci_cd, :providers, credential_key.to_sym)
    end
    ...
    def only_one_default_per_account
      existing_default = account.ci_cd_providers.default_provider.where.not(id: id).exists?
    ...
    def ensure_single_default
      ...
      account.ci_cd_providers.where.not(id: id).update_all(is_default: false)
    end
  end
end
