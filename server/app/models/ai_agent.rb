...
class AiAgent < ApplicationRecord
  ...
  # Extracted concerns
  include AiAgent::StatusChecks
  include AiAgent::McpTool
  include AiAgent::McpRegistration
  include AiAgent::McpSchemas
  include AiAgent::Execution
  include AiAgent::Statistics
  include AiAgent::Operations
