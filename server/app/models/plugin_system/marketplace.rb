...
module PluginSystem
  ...
  class Marketplace < ApplicationRecord
    ...
    has_many :plugins, class_name: "PluginSystem::Definition", foreign_key: :source_marketplace_id, dependent: :nullify
    ...
    def sync_plugins
      PluginSystem::MarketplaceSyncService.new(self).sync
    end
