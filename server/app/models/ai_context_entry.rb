...
class AiContextEntry < ApplicationRecord
  # ==================== Concerns ====================
  include Auditable
  ...
  # ==================== Associations ====================
  belongs_to :ai_persistent_context
  belongs_to :created_by_user, class_name: "User", optional: true
  belongs_to :ai_agent, optional: true
  belongs_to :previous_version, class_name: "AiContextEntry", optional: true

  has_many :newer_versions, class_name: "AiContextEntry", foreign_key: :previous_version_id, dependent: :nullify
  ...
  def update_content(new_content, create_version: true)
    if create_version && content != new_content
      ...
      new_entry = ai_persistent_context.ai_context_entries.create!(
        entry_key: entry_key,
        entry_type: entry_type,
        content: new_content,
        metadata: metadata,
  ...
  def update_context_entry_count
    ai_persistent_context.update_column(:entry_count, ai_persistent_context.ai_context_entries.active.count)
  end
end
