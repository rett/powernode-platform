  ...
  module V1
    module CiCd
      class PromptTemplatesController < ApplicationController
        ...
        # GET /api/v1/ci_cd/prompt_templates
        def index
        ...
        # GET /api/v1/ci_cd/prompt_templates/:id
        def show
          render_success({
        ...
        # POST /api/v1/ci_cd/prompt_templates
        def create
          template = prompt_templates_scope.new(prompt_template_params)
          template.created_by = current_user
          template.domain = "cicd" # Ensure domain is set for CI/CD templates
        ...
        # PATCH/PUT /api/v1/ci_cd/prompt_templates/:id
        def update
        ...
        # DELETE /api/v1/ci_cd/prompt_templates/:id
        def destroy
        ...
        # POST /api/v1/ci_cd/prompt_templates/:id/preview
        def preview
        ...
        # POST /api/v1/ci_cd/prompt_templates/:id/duplicate
        def duplicate
        ...
        # Scope to CI/CD-accessible templates (cicd domain + general)
        ...
        def require_read_permission
          return if current_user.has_permission?("ci_cd.prompt_templates.read")

          render_error("Insufficient permissions to view prompt templates", status: :forbidden)
        end

        def require_write_permission
          return if current_user.has_permission?("ci_cd.prompt_templates.write")
