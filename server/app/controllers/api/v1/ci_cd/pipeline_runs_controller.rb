  ...
  module V1
    module CiCd
      class PipelineRunsController < ApplicationController
        ...
        # GET /api/v1/ci_cd/pipeline_runs/:id
        def show
          render_success({
        ...
        # POST /api/v1/ci_cd/pipeline_runs/:id/cancel
        def cancel
        ...
        # POST /api/v1/ci_cd/pipeline_runs/:id/retry
        def retry
        ...
        # GET /api/v1/ci_cd/pipeline_runs/:id/logs
        def logs
        ...
        def require_read_permission
          return if current_user.has_permission?("ci_cd.pipeline_runs.read")

          render_error("Insufficient permissions to view pipeline runs", status: :forbidden)
        end

        def require_write_permission
          return if current_user.has_permission?("ci_cd.pipeline_runs.write")
