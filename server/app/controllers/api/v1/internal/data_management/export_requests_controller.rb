...
class Api::V1::Internal::DataManagement::ExportRequestsController < Api::V1::Internal::InternalBaseController
  ...
  def create
    @request = DataManagement::ExportRequest.new(request_params)
  ...
  def set_request
    @request = DataManagement::ExportRequest.find(params[:id])
