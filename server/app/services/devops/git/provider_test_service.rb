...
module Devops
  ...
  class ProviderTestService
    ...
    def test_connection
    ...
    rescue Devops::Git::ApiClient::AuthenticationError => e
      error_result("Authentication failed: #{e.message}", 0, "authentication_error")
    rescue Devops::Git::ApiClient::RateLimitError => e
      ...
      Rails.logger.error "Devops::Git::ProviderTestService error: #{e.message}"
