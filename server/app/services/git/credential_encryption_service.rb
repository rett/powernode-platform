  ...
  class CredentialEncryptionService
    ...
    class << self
      def encrypt(credentials_hash)
        ...
        Rails.logger.error "Git::CredentialEncryptionService encrypt error: #{e.message}"
      ...
      def decrypt(encrypted_data, key_id = nil)
        ...
        Rails.logger.error "Git::CredentialEncryptionService decrypt error: Invalid message"
        raise DecryptionError, "Failed to decrypt credentials: Invalid encryption"
      rescue JSON::ParserError => e
        Rails.logger.error "Git::CredentialEncryptionService decrypt error: Invalid JSON"
        raise DecryptionError, "Failed to decrypt credentials: Invalid data format"
      rescue StandardError => e
        Rails.logger.error "Git::CredentialEncryptionService decrypt error: #{e.message}"
...
GitCredentialEncryptionService = Git::CredentialEncryptionService unless defined?(GitCredentialEncryptionService)
