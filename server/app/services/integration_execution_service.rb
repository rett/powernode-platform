...
class IntegrationExecutionService
  ...
  EXECUTOR_MAPPING = {
    "github_action" => "Integrations::GithubActionExecutor",
    "webhook" => "Integrations::WebhookExecutor",
    "mcp_server" => "Integrations::McpServerExecutor",
    "rest_api" => "Integrations::RestApiExecutor"
  }.freeze
  ...
  class << self
    ...
    def execute(instance:, input: {}, triggered_by: nil, context: {})
      ...
      rescue Integrations::BaseExecutor::ExecutionError => e
        {
          success: false,
          execution_id: execution.id,
          error: e.message,
    ...
    def build_executor(instance, execution: nil, context: {})
      integration_type = instance.integration_template.integration_type
    ...
    def retry_execution(execution:, context: {})
      ...
      instance = execution.integration_instance
    ...
    def execution_history(instance:, filters: {}, page: 1, per_page: 20)
      scope = IntegrationExecution.where(integration_instance: instance)
    ...
    def execution_stats(instance:, period: 30.days)
      executions = IntegrationExecution
        .where(integration_instance: instance)
