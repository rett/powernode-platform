...
module Integrations
  class CredentialEncryptionService
    ...
    class << self
      # Encrypt credentials for an Integration::Credential record
      def encrypt(credential_record, credentials_hash)
        raise EncryptionError, "Invalid credential record" unless credential_record.is_a?(Integration::Credential)
      ...
      # Decrypt credentials from an Integration::Credential record
      def decrypt(credential_record)
        raise DecryptionError, "Invalid credential record" unless credential_record.is_a?(Integration::Credential)
