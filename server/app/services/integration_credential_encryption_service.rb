...
class IntegrationCredentialEncryptionService
  ...
  class << self
    # Encrypt credentials for an IntegrationCredential record
    def encrypt(credential_record, credentials_hash)
      raise EncryptionError, "Invalid credential record" unless credential_record.is_a?(IntegrationCredential)
    ...
    # Decrypt credentials from an IntegrationCredential record
    def decrypt(credential_record)
      raise DecryptionError, "Invalid credential record" unless credential_record.is_a?(IntegrationCredential)
    ...
    # Decrypt raw data (for standalone use)
