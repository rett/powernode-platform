...
# Ai::ErrorRecoveryService - Intelligent error recovery for AI provider operations
#
...
#   recovery = Ai::ErrorRecoveryService.new(account, execution_context)
