  ...
  module NodeExecutors
    ...
    class KbArticleCreate < Base
      ...
      def validate_article_data!(data)
        ...
        unless KnowledgeBase::Category.exists?(data[:category_id])
          raise Mcp::AiWorkflowOrchestrator::NodeExecutionError,
      ...
      def find_or_create_default_category
        ...
        category = KnowledgeBase::Category.find_by(slug: "ai-generated") ||
                   KnowledgeBase::Category.find_by(slug: "general") ||
                   KnowledgeBase::Category.first
