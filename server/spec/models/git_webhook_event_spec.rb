...
RSpec.describe GitWebhookEvent, type: :model do
  ...
  describe 'scopes' do
    ...
    let!(:pending_event) { create(:git_webhook_event, :pending, git_provider: provider, account: account, git_repository: repo) }
    let!(:processing_event) { create(:git_webhook_event, :processing, git_provider: provider, account: account, git_repository: repo) }
    let!(:processed_event) { create(:git_webhook_event, :processed, git_provider: provider, account: account, git_repository: repo) }
    let!(:failed_event) { create(:git_webhook_event, :failed, git_provider: provider, account: account, git_repository: repo) }
    ...
    describe '.retryable' do
      let!(:retryable_event) { create(:git_webhook_event, :retrying, git_provider: provider, account: account, git_repository: repo) }
      let!(:max_retries_event) { create(:git_webhook_event, :max_retries, git_provider: provider, account: account, git_repository: repo) }
    ...
    describe '.by_event_type' do
      let!(:push_event) { create(:git_webhook_event, :push, git_provider: provider, account: account, git_repository: repo) }
      let!(:pr_event) { create(:git_webhook_event, :pull_request, git_provider: provider, account: account, git_repository: repo) }
    ...
    describe '.by_action' do
      let!(:opened_event) { create(:git_webhook_event, :pull_request, action: 'opened', git_provider: provider, account: account, git_repository: repo) }
      let!(:closed_event) { create(:git_webhook_event, :pull_request, action: 'closed', git_provider: provider, account: account, git_repository: repo) }
    ...
    describe '.for_repository' do
      let(:other_repo) { create(:git_repository, git_provider_credential: credential, account: account) }
      let!(:other_event) { create(:git_webhook_event, git_provider: provider, account: account, git_repository: other_repo) }
