...
RSpec.describe Ai::WorkflowTrigger, type: :model do
  subject(:trigger) { build(:ai_workflow_trigger) }

  describe 'associations' do
    it { is_expected.to belong_to(:workflow) }
    it { is_expected.to have_many(:workflow_runs).dependent(:nullify) }
  end
  ...
  describe 'validations' do
    ...
    it 'validates inclusion of trigger_type' do
      ...
      valid_types.each do |type|
        ...
        attrs = { workflow: workflow, trigger_type: type, name: "Test #{type} trigger" }
        case type
        when 'manual'
  ...
  describe 'instance methods' do
    ...
    describe '#can_trigger?' do
      ...
      it 'returns true for active triggers with executable workflows' do
        trigger = create(:ai_workflow_trigger, workflow: workflow, status: 'active', is_active: true)
      ...
      it 'returns false for inactive triggers' do
        trigger = create(:ai_workflow_trigger, workflow: workflow, status: 'paused', is_active: false)
