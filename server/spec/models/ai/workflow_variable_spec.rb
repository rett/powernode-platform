...
RSpec.describe Ai::WorkflowVariable, type: :model do
  ...
  describe 'validations' do
    ...
    context 'name validation' do
      ...
      it 'validates name uniqueness within workflow' do
        ...
        create(:ai_workflow_variable, workflow: workflow, name: 'duplicate_name')

        duplicate = build(:ai_workflow_variable, workflow: workflow, name: 'duplicate_name')
      ...
      it 'allows same name in different workflows' do
        ...
        create(:ai_workflow_variable, workflow: workflow1, name: 'same_name')
        duplicate = build(:ai_workflow_variable, workflow: workflow2, name: 'same_name')
