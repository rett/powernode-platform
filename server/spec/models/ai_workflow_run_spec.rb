...
RSpec.describe AiWorkflowRun, type: :model do
  ...
  describe 'associations' do
    ...
    it { is_expected.to belong_to(:ai_workflow_trigger).optional }
    ...
    it { is_expected.to have_many(:ai_workflow_checkpoints).dependent(:destroy) }
    it { is_expected.to have_many(:ai_agent_messages).dependent(:destroy) }
  end
  ...
  describe 'instance methods' do
    ...
    describe '#can_retry?' do
      it 'returns true for failed runs when workflow can execute' do
        ...
        run = create(:ai_workflow_run, :failed, ai_workflow: workflow)
