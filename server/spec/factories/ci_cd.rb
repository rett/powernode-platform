...
FactoryBot.define do
  factory :ci_cd_pipeline, class: 'CiCd::Pipeline' do
    association :account
  ...
  factory :ci_cd_pipeline_step, class: 'CiCd::PipelineStep' do
    association :pipeline, factory: :ci_cd_pipeline
  ...
  factory :ci_cd_pipeline_run, class: 'CiCd::PipelineRun' do
    association :pipeline, factory: :ci_cd_pipeline
  ...
  factory :ci_cd_step_execution, class: 'CiCd::StepExecution' do
    association :pipeline_run, factory: :ci_cd_pipeline_run
    association :pipeline_step, factory: :ci_cd_pipeline_step
    status { 'pending' }
    outputs { {} }
  ...
  factory :ci_cd_step_approval_token, class: 'CiCd::StepApprovalToken' do
    association :step_execution, factory: [:ci_cd_step_execution, :waiting_approval]
