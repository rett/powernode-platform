...
FactoryBot.define do
  factory :ai_workflow_node_execution do
    ...
    input_data do
      {
        ...
        workflow_variables: ai_workflow_run.input_variables,
        execution_context: {
          run_id: ai_workflow_run.run_id,
          node_position: 1
        }
      }
    end
    ...
    trait :ai_agent_execution do
      ai_workflow_node { create(:ai_workflow_node, :ai_agent, ai_workflow: ai_workflow_run.ai_workflow) }
      input_data do
        {
    ...
    trait :api_call_execution do
      ai_workflow_node { create(:ai_workflow_node, :api_call, ai_workflow: ai_workflow_run.ai_workflow) }
      input_data do
        {
    ...
    trait :webhook_execution do
      ai_workflow_node { create(:ai_workflow_node, :webhook, ai_workflow: ai_workflow_run.ai_workflow) }
      input_data do
        {
    ...
    trait :condition_execution do
      ai_workflow_node { create(:ai_workflow_node, :condition, ai_workflow: ai_workflow_run.ai_workflow) }
      input_data do
        {
    ...
    trait :transform_execution do
      ai_workflow_node { create(:ai_workflow_node, :transform, ai_workflow: ai_workflow_run.ai_workflow) }
      input_data do
        {
    ...
    trait :delay_execution do
      ai_workflow_node { create(:ai_workflow_node, :delay, ai_workflow: ai_workflow_run.ai_workflow) }
      input_data do
        {
          delay_duration: 30,
          delay_unit: 'seconds',
    ...
    trait :human_approval_execution do
      ai_workflow_node { create(:ai_workflow_node, :human_approval, ai_workflow: ai_workflow_run.ai_workflow) }
    ...
    trait :sub_workflow_execution do
      ai_workflow_node { create(:ai_workflow_node, :sub_workflow, ai_workflow: ai_workflow_run.ai_workflow) }
      input_data do
        {
    ...
    trait :blog_content_generation do
      ai_workflow_node { create(:ai_workflow_node, :blog_writer, ai_workflow: ai_workflow_run.ai_workflow) }
      input_data do
        {
    ...
    trait :content_quality_check do
      ai_workflow_node { create(:ai_workflow_node, :content_reviewer, ai_workflow: ai_workflow_run.ai_workflow) }
      input_data do
        {
