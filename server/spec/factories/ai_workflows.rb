  ...
  factory :ai_workflow do
    ...
    trait :with_simple_chain do
      after(:create) do |workflow|
        ...
        agent_node = create(:ai_workflow_node, :ai_agent, ai_workflow: workflow, name: 'Process Agent')
    ...
    trait :with_variables do
      after(:create) do |workflow|
        create(:ai_workflow_variable, :string_type, ai_workflow: workflow, name: 'input_text')
        create(:ai_workflow_variable, :number_type, ai_workflow: workflow, name: 'max_tokens')
      end
    end
    ...
    trait :with_parallel_execution do
      ...
      after(:create) do |workflow|
        start_node = create(:ai_workflow_node, :start_node, ai_workflow: workflow)
        agent1 = create(:ai_workflow_node, :ai_agent, ai_workflow: workflow, name: 'Agent 1')
        agent2 = create(:ai_workflow_node, :ai_agent, ai_workflow: workflow, name: 'Agent 2')
        end_node = create(:ai_workflow_node, :end_node, ai_workflow: workflow)
    ...
    trait :with_conditional_branch do
      ...
      after(:create) do |workflow|
        ...
        true_branch = create(:ai_workflow_node, :ai_agent, ai_workflow: workflow, name: 'True Branch')
        false_branch = create(:ai_workflow_node, :ai_agent, ai_workflow: workflow, name: 'False Branch')
        end_node = create(:ai_workflow_node, :end_node, ai_workflow: workflow)
        ...
        create(:ai_workflow_edge, :conditional, ai_workflow: workflow,
