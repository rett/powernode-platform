...
FactoryBot.define do
  factory :ai_workflow_execution_log do
    ai_workflow_run
    account { ai_workflow_run.account }
    log_level { 'info' }
      ...
      log_data do
        {
          ...
          workflow_id: ai_workflow_run.ai_workflow.id,
          workflow_name: ai_workflow_run.ai_workflow.name,
          trigger_type: ai_workflow_run.trigger_type,
          input_variables: ai_workflow_run.input_variables,
          total_nodes: 5,
