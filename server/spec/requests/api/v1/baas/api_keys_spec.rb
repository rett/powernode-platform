...
RSpec.describe "Api::V1::BaaS::ApiKeys", type: :request do
  ...
  describe "GET /api/v1/baas/api_keys" do
    before do
    ...
    it "returns list of API keys" do
      get "/api/v1/baas/api_keys", headers: headers
    ...
    it "filters by environment" do
      get "/api/v1/baas/api_keys", params: { environment: "development" }, headers: headers
  ...
  describe "POST /api/v1/baas/api_keys" do
    let(:valid_params) do
      {
        name: "New API Key",
    ...
    it "creates a new API key" do
      ...
      post "/api/v1/baas/api_keys", params: valid_params.to_json, headers: headers
    ...
    it "returns 422 for invalid params" do
      post "/api/v1/baas/api_keys", params: { name: "" }.to_json, headers: headers

      expect(response).to have_http_status(:unprocessable_content)
    end
  end

  describe "POST /api/v1/baas/api_keys/:id/roll" do
    let!(:api_key_result) { service.create_key(name: "Original Key", environment: "development") }
    let(:api_key) { api_key_result[:api_key] }

    it "rolls the API key" do
      post "/api/v1/baas/api_keys/#{api_key.id}/roll", headers: headers
