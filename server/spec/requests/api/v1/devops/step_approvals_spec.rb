...
RSpec.describe 'Api::V1::Devops::StepApprovals', type: :request do
  ...
  describe 'GET /api/v1/devops/step_approvals/:token' do
    context 'with valid token' do
      it 'returns token details without authentication' do
        get "/api/v1/devops/step_approvals/#{raw_token}"
    ...
    context 'with invalid token' do
      it 'returns not found' do
        get '/api/v1/devops/step_approvals/invalid_token_12345'
  ...
  describe 'POST /api/v1/devops/step_approvals/:token/approve' do
    before do
    ...
    context 'with valid pending token' do
      it 'approves the step without authentication' do
        post "/api/v1/devops/step_approvals/#{raw_token}/approve",
    ...
    context 'with comment required' do
      ...
      it 'rejects approval without comment' do
        post "/api/v1/devops/step_approvals/#{@raw_token_comment}/approve",
             as: :json
    ...
    context 'with invalid token' do
      it 'returns not found' do
        post '/api/v1/devops/step_approvals/invalid_token/approve',
             as: :json
  ...
  describe 'POST /api/v1/devops/step_approvals/:token/reject' do
    before do
      allow_any_instance_of(Devops::StepExecution).to receive(:handle_approval_response!).and_return(true)
    end
    ...
    context 'with valid pending token' do
      it 'rejects the step without authentication' do
        post "/api/v1/devops/step_approvals/#{raw_token}/reject",
    ...
    context 'with comment required' do
      ...
      it 'rejects without comment' do
        post "/api/v1/devops/step_approvals/#{@raw_token_reject}/reject",
             as: :json
    ...
    context 'with invalid token' do
      it 'returns not found' do
        post '/api/v1/devops/step_approvals/invalid_token/reject',
             as: :json
  ...
  describe 'authentication behavior' do
    ...
    it 'does not require JWT authentication for approve' do
      ...
      post "/api/v1/devops/step_approvals/#{raw_token}/approve", as: :json
      expect(response).not_to have_http_status(:unauthorized)
    end
    ...
    it 'does not require JWT authentication for reject' do
      ...
      post "/api/v1/devops/step_approvals/#{raw_token}/reject", as: :json
      expect(response).not_to have_http_status(:unauthorized)
    end
  end
