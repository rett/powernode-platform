...
import { NavigationSection as NavSection } from '../../types/navigation';
...
export const NavigationSection: React.FC<NavigationSectionProps> = ({ 
  ...
  if (!hasPermission(section.permissions, section.roles)) {
    return null;
  }

  // Filter items by permissions
  const visibleItems = section.items.filter(item => 
    hasPermission(item.permissions, item.roles)
  );
