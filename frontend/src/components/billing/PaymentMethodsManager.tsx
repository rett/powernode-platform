        ...
        <div className="text-center py-8 bg-theme-surface rounded-lg border border-theme">
          ...
          {showAddButton && (
            <button
              onClick={handleAddPaymentMethod}
              disabled={addingMethod}
              className="px-4 py-2 bg-theme-interactive-primary text-white rounded-md hover:bg-theme-interactive-primary-hover disabled:opacity-50 disabled:cursor-not-allowed"
            >
                  ...
                  <div className="flex items-center gap-2">
                    {!isDefault && (
                      <button
                        ...
                        className="px-3 py-1 text-sm border border-theme text-theme-primary rounded hover:bg-theme-surface transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1"
                      >
                    ...
                    <button
                      ...
                      className="p-2 text-theme-error hover:bg-theme-error-background rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
