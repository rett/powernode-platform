...
import { versionApi, VersionInfo, FullVersionInfo, HealthInfo } from '../../services/versionApi';
  ...
  useEffect(() => {
    const fetchVersionInfo = async () => {
      try {
        ...
        if (showBackend) {
          const [versionResponse, fullResponse, healthResponse] = await Promise.all([
            versionApi.getVersion(),
            show === 'detailed' ? versionApi.getFullVersion() : Promise.resolve({ success: false, data: {} as FullVersionInfo }),
            show === 'detailed' ? versionApi.getHealth() : Promise.resolve({ success: false, data: {} as HealthInfo })
          ]);
          ...
          if (fullResponse.success) {
            setFullVersion(fullResponse.data);
          }
