...
import { Worker, WorkerDetailsResponse, workerAPI, UpdateWorkerData } from '../../services/workerApi';
    ...
    return (
      <div className="text-center py-8">
        <div className="bg-theme-error-background rounded-lg p-4 max-w-md mx-auto">
          <p className="text-red-700 font-medium">Error Loading Worker Details</p>
