          ...
          {subscription.status === 'active' && !showCancelConfirm && (
            <div className="border-t pt-4">
              <button
                ...
                className="text-theme-error hover:text-theme-error text-sm font-medium transition-colors"
              >
                Cancel Subscription
              </button>
            </div>
            ...
            <div className="border border-theme-error-border bg-theme-error-background p-4 rounded-lg">
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  disabled={loading}
                  className="bg-theme-error hover:bg-theme-error text-white px-3 py-1 rounded-md text-sm disabled:opacity-50 transition-colors"
                >
