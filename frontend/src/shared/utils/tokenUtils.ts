...
/**
 * Validates token format - this app uses traditional tokens (not JWTs)
 * Traditional tokens are base64-encoded strings generated by SecureRandom
 */
export const isValidTokenFormat = (token: string): boolean => {
  if (!token || typeof token !== 'string') return false;
  
  // Traditional tokens should be:
  // - Non-empty strings
  // - URL-safe base64 encoded (alphanumeric, -, _)
  // - Reasonable length (typically 32-64 characters)
