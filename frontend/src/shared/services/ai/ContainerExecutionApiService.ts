 ...
 * - POST   /api/v1/mcp/containers/execute
...
class ContainerExecutionApiService extends BaseApiService {
  private containersPath = '/mcp/containers';
  private templatesPath = '/mcp/templates';
  private quotasPath = '/mcp/quotas';
