    ...
    <div className="bg-theme-warning bg-opacity-10 border-b border-theme-warning border-opacity-30 px-4 py-2 text-sm">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <button
          ...
          className="inline-flex items-center px-3 py-1 border border-theme-warning border-opacity-50 rounded-md text-xs font-medium text-theme-warning bg-theme-surface hover:bg-theme-surface-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-theme-warning disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
          {isLoading ? (
            <>
