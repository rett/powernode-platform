...
describe('ConsentManager', () => {
  ...
  describe('icons', () => {
    it('shows emoji icons for consent types', () => {
      ...
      expect(screen.getByText('🔌')).toBeInTheDocument(); // third_party
      expect(screen.getByText('📧')).toBeInTheDocument(); // communications
      expect(screen.getByText('📰')).toBeInTheDocument(); // newsletter
      expect(screen.getByText('🎁')).toBeInTheDocument(); // promotional
    });
  });
