  ...
  return (
    <div className="space-y-6">
                ...
                <tr key={user.id} className="hover:bg-theme-surface-hover">
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center space-x-2">
                      ...
                      {user.status === 'active' ? (
                        <Button variant="outline" onClick={() => handleSuspendUser(user.id)}
                          className="text-theme-warning hover:text-theme-warning-hover text-sm"
                        >
                          Suspend
                        </Button>
                      ) : (
                        <Button variant="outline" onClick={() => handleActivateUser(user.id)}
                          className="text-theme-success hover:text-theme-success-hover text-sm"
                        >
                          Activate
                        </Button>
                      )}
                      <Button variant="outline" onClick={() => handleImpersonateUser(user.id)}
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Button variant="outline" onClick={() => navigator.clipboard.writeText(selectedUser.id)}
      ...
      <CreateUserModal
        ...
        onSuccess={async () => {
          await loadSystemData(); // Reload users list after successful creation
        }}
        accounts={accounts}
      />
    </div>
