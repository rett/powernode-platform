...
import { reverseProxyApi, GeneratedConfig } from '../../services/reverseProxyApi';
import { 
  Download, 
  Copy,
  FileText,
...
const proxyTypes = [
  { value: 'nginx' as ProxyType, label: 'Nginx', description: 'Popular high-performance web server and reverse proxy' },
  { value: 'apache' as ProxyType, label: 'Apache HTTP Server', description: 'Widely used open-source web server' },
  { value: 'traefik' as ProxyType, label: 'Traefik', description: 'Modern reverse proxy and load balancer for microservices' }
];
