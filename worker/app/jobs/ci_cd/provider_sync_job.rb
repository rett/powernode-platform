...
module CiCd
  ...
  class ProviderSyncJob < BaseJob
    ...
    def update_provider(provider_id, **attributes)
      api_client.patch("/api/v1/internal/ci_cd/providers/#{provider_id}", {
        provider: attributes
      })
    end
    ...
    def find_existing_repository(provider_id, external_id)
      response = api_client.get("/api/v1/internal/ci_cd/repositories", {
        provider_id: provider_id,
    ...
    def create_repository(provider_id, data)
      api_client.post("/api/v1/internal/ci_cd/repositories", {
    ...
    def update_repository(repository_id, data)
      api_client.patch("/api/v1/internal/ci_cd/repositories/#{repository_id}", {
